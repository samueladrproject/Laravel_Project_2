        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header bg-success">
                    <h6 class="p-0 m-0 fw-bold">Ubah Data Gejala</h6>
                </div>
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ URL::to('data-gejala/' . $idDataGejala) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-2">
                                <input type="text" class="form-control @error('kode_gejala') is-invalid @enderror"
                                    id="kode_gejala" name="kode_gejala" autofocus
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control mb-4 @error('nama_gejala') is-invalid @enderror"
