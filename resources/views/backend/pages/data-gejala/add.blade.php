        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header bg-success">
                    <h6 class="p-0 m-0 fw-bold">Tambah Data Gejala</h6>
                </div>
                <div class="card-body">
                    ...
                    <form action="{{ URL::to('data-gejala') }}" method="POST">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-2">
                                <input type="text" class="form-control @error('kode_gejala') is-invalid @enderror"
                                    id="kode_gejala" name="kode_gejala" autofocus value="{{ old('kode_gejala') }}">
                                @error('kode_gejala')
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-4">
                                <input type="text" class="form-control @error('nama_gejala') is-invalid @enderror mb-3"
