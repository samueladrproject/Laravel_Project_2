        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header bg-success">
                    <h6 class="p-0 m-0 fw-bold">Ubah Data Aturan</h6>
                </div>
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ URL::to('data-aturan/' . $idDataAturan) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-4">
                                <select class="form-select" id="nama_penyakit" name="nama_penyakit">
                                    ...
                                    @foreach ($dataPenyakit as $penyakit)
                                        @if (old('nama_penyakit', $dataaturan->nama_penyakit) == $penyakit->nama_penyakit)
                            ...
                            <div class="col-sm-4">
                                <select class="form-select" id="kode_gejala" name="kode_gejala">
                                    ...
                                    @foreach ($dataGejala as $gejala)
                                        @if (old('kode_gejala', $dataaturan->kode_gejala) == $gejala->kode_gejala)
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-4">
                                <select class="form-select" id="nama_gejala" name="nama_gejala">
                                    ...
                                    @foreach ($dataGejala as $gejala)
                                        @if (old('nama_gejala', $dataaturan->nama_gejala) == $gejala->nama_gejala)
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-4">
                                <input type="number" class="form-control @error('nilai_cf') is-invalid @enderror mb-3"
                                    id="nilai_cf" name="nilai_cf" value="{{ old('nilai_cf', $dataaturan->nilai_cf) }}"
                                    step="0.01">
                                @error('nilai_cf')
                                    <div class="invalid-feedback">
                                        {{ $message }}
