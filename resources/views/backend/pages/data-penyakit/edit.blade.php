        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header bg-success">
                    <h6 class="p-0 m-0 fw-bold">Ubah Data Penyakit</h6>
                </div>
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ URL::to('data-penyakit/' . $idDataPenyakit) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-2">
                                <input type="text" class="form-control @error('kode_penyakit') is-invalid @enderror"
                                    id="kode_penyakit" name="kode_penyakit" autofocus
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-5">
                                <textarea type="text" class="form-control mb-4 @error('solusi') is-invalid @enderror" id="solusi"
                                    name="solusi">{{ old('solusi', $datapenyakit->solusi) }}</textarea>
                                @error('solusi')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
